...
router.post(
  "/gym/:gymId/extend-memberships",
  verifyToken,
  requireRole("gym_admin"),
  controllers.gymController.extendMemberships,
);

router.post(
  "/gym/:gymId/cancel-affected-classes",
  verifyToken,
  requireRole("gym_admin"),
  controllers.gymController.cancelAffectedClasses,
);
